...
def lffs_to_image(lffs_dir, img_dir):
    ...
    for i, path in enumerate(path_list):
        ...
        out_path = os.path.join(img_dir, "%s.png" % name)
...
if __name__ == "__main__":
    lffs_dir = r"E:\KSIP\NIST_SD302\sd302h\ebts\latent\lffs\original\1000"
    out_dir = r"E:\KSIP\NIST_SD302\sd302h\png\latent\lffs\original\1000"
